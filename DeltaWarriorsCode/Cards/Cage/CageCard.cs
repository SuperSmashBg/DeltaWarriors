...
namespace DeltaWarriors.DeltaWarriorsCode.Cards.Cage;
...
/// </summary>
[Pool(typeof(TheCageCardPool))]
public abstract class CageCard(int cost, CardType type, CardRarity rarity, TargetType target) :
