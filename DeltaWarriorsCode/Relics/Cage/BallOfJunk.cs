...
public class BallOfJunk() : DeltaWarriors.DeltaWarriorsCode.Relics.CageRelic
{
    public override RelicRarity Rarity => RelicRarity.Starter;
    private CardModel? _selectedCard;
    private bool _usedThisCombat = true;
    protected override IEnumerable<DynamicVar> CanonicalVars => [new EnergyVar(1)];
    public override RelicModel GetUpgradeReplacement() => ModelDb.Relic<BallOfJunkPlus>();
    ...
    {
        if (_selectedCard != null || card.Owner != Owner || card.Keywords.Contains(CardKeyword.Exhaust) || card.Type == CardType.Power 
    ...
    public override async Task BeforeHandDraw(Player player, PlayerChoiceContext choiceContext, ICombatState combatState)
    {
        ...
        if (_selectedCard.Pile != null && _selectedCard.Pile.Type != PileType.Exhaust && _selectedCard.Pile.Type != PileType.None)
        {
            ...
            _selectedCard.EnergyCost.AddThisCombat(-1);
            Flash();
        }
